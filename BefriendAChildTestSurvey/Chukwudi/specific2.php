...
<div class="nav-outer-repeat">
    ...
    <div class="nav-outer">
        ...
        <div id="nav-right">
            ...
            <div class="nav-divider">&nbsp;</div>
            <a href="../Chukwudi/logout.php" id="logout"><img src="imagesadminpage/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
            <div class="clear">&nbsp;</div>
...
<div id="content-outer">
    ...
    <div class="container">
        <table class="table table-striped">
            ...
            $email = $_GET['vol_email'];

            $sql = "select question_text, question_id from questions";

            $sql2 = "select submission_id from submissions where vol_id =(select vol_id from volunteers where vol_email='$vol_email')";
            ...
            if(mysqli_num_rows($results)>0){
                ...
                while ($row= mysqli_fetch_array($results))
                {
                    ...
                    <tr>
                        ...
                        <td><a href="specific3.php?question_id=<?php echo $row['question_id'];?>"><?php echo $row['question_text']; ?></a></td>
                    </tr>
                    </tbody>
                    <?php
